...
class AdGenerator:
    ...
    def generate_base_image(self, product, age, location, gender, profession):
        ...
        prompt = f"{age}-year-old happy {gender} {profession}, {location}, India, facing towards {prompt_product.split()[0]} (hidden logo) in foreground, sharp focus on {prompt_product.split()[0]}, beside person. "\
