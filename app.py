...
class AdGenerator:
    ...
    def generate_base_image(self, product, age, location, gender, profession):
        ...
        prompt = f"A White-label {prompt_product.split()[0]} position dominant foreground crisp focus, adjacent a {age}-year-old cheerful {gender}, {profession}, {location}, India. " \
